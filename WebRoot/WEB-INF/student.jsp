		...
		<table width="79%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td heigth="329" valign="top">
					<%
						ArrayList studentList = Student_Manager.getStudentList();
					%>
					<div align="center">
						<table width="80%" border="0" cellspacing="1" cellpadding="1"
							...
							<tr background="./images/front/bg_1_gif">
								<td colspan="2" align="center"
									backgound="./images/front/bg_1_.gif" class="whitenormal">
									老师信息
								</td>
							</tr>
							<%
							...
							<tr bgcolor="F1F3F5">
								...
								<td width="90%" class="nornalText">
									<%=student.getSex()%></td>
							</tr>
							<td align="center" class="normalText">
								年级：
							</td>
							<td class="normalText"><%=student.getGrade_id()%></td>
							</tr>
							<tr bgcolor="#F1F3F5">
								<td align="center" class="normalText">
									图片：
								...
								<td>
									<img src=<%="./images/face/" + student.getImage()%>
										height="38">
								</td>
							</tr>
